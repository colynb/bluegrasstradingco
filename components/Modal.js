            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
              <div>
                <div className="text-center">
                  ...
                  >
                    Thanks! Email received but you&apos;re not done!
                  </Dialog.Title>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      We received your email but before we can send you updates,
                      you need to verify your email by clicking the link we just
                      sent you. This helps us avoid sending emails to fakes or
                      accidental typos. Thanks!
                    </p>
                  </div>
                </div>
              </div>
